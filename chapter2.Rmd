...
```
The assumption is that the strategic approach (stra) defines the overall points (Points).
Residual is the difference between an observed value of the response variable and the fitted value, the error.
y the assumptions of normality and
constant variance can be assessed.
